...
export type ResolversTypes = ResolversObject<{
  ...
  _Entity: ResolversTypes['Band'] | ResolversTypes['Fan'];
  _Service: ResolverTypeWrapper<any>;
}>;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  _Any: Scalars['_Any'];
  _Entity: ResolversParentTypes['Band'] | ResolversParentTypes['Fan'];
  _Service: any;
}>;
